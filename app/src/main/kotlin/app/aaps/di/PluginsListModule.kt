...
import app.aaps.plugins.smoothing.ModifiedSincSmoothingPlugin
...
abstract class PluginsListModule {
    ...
    @IntoMap
    @IntKey(615)
    abstract fun bindModifiedSincSmoothingPlugin(plugin: ModifiedSincSmoothingPlugin): PluginBase
